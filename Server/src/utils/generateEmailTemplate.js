export const generateEmailTemplate = (resetPasswordUrl) => {
    return `
        <h1>Password Reset Request</h1> <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000; color: #fff;">
